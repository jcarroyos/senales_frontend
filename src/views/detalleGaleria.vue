        ...
        <div id="contenidoIniciodetalle" class="container contenttitulo">
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-5 contentparrafo">              
               ...
               <div>
                     <div>
                        <b-button v-b-modal.modal-1>Particpar</b-button>
          ...
          <div class="row">
            ...
            <div class="row">
              ...
              <div class="grid" id="detallereflejos">
                ...
                <masonry style="display:flex" :cols="{default: 5, 1000: 4, 700: 2, 400: 1}"  :gutter="{default: '10px', 700: '10px'}" data-masonry-options='{ "columnWidth": 200}'> 
